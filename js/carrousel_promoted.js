...
$(document).ready( function() {
    ...
    var card_names = [ 'Dog Food', 'Juguete', 'Comedero', 'Collar' ]
    ...
    for (let i = start; i < end; i++) {
        ...
        <div class="card flex-shrink-0 d-flex flex-column justify-content-between ">
            <div class="card-img d-flex justify-content-center align-items-center">
                <img src="./` + insert + `promoted_items/item_` + i + `/img.png" class="card-img-top" alt="...">
            </div>
            <div class="card-body">
    ...
    $('.destacado .carrousel-wrapper').html( html_out )
